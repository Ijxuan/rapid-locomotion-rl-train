...
class Cfg(PrefixProto, cli=False):
    ...
    class commands(PrefixProto, cli=False):
        ...
        paper_b_command_curriculum = False
        ...
        paper_b_vx_initial = [-0.5, 1.0]
        paper_b_vx_final = [-1.75, 3.5]
        paper_b_vx_curriculum_k = 0.002
        paper_b_vx_curriculum_midpoint = 1000
    ...
    class init_state(PrefixProto, cli=False):
        ...
        noise_lin_vel_x = [-1.0, 1.0]
        noise_lin_vel_yz = [-0.5, 0.5]
        noise_ang_vel = [-0.7, 0.7]
    ...
    class domain_rand(PrefixProto, cli=False):
        ...
        motor_friction_haa_hfe_range = [0.0, 0.3]
        motor_friction_kfe_range = [0.1, 0.7]
        randomize_pd_gains = False
        Kp_noise_range = [-2.0, 2.0]
        Kd_noise_range = [-0.1, 0.1]
        randomize_foot_radius = False
        foot_radius_range = [0.006, 0.010]
        foot_position_noise_range = [[-0.010, 0.010], [-0.005, 0.005], [-0.020, 0.020]]
        obs_noise_dof_pos = [-0.05, 0.05]
        obs_noise_dof_vel = [-0.5, 0.5]
        obs_noise_base_quat = [-0.03, 0.03]
        obs_noise_foot_pos = [-0.03, 0.03]
        obs_noise_base_ang_vel = [-0.1, 0.1]
        push_robots = True
        push_interval_s = 15
        max_push_vel_xy = 1.
    ...
    class rewards(PrefixProto, cli=False):
        ...
        use_paper_b_reward = False
        paper_b_reward_exponential_scale = 0.02
        paper_b_reward_gate_floor = 0.05
        paper_b_desired_foot_height = 0.09
        paper_b_termination_penalty = -10.0
        paper_b_stance_command_threshold = 0.1
