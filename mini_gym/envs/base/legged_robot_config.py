...
class Cfg(PrefixProto, cli=False):
    ...
    class commands(PrefixProto, cli=False):
        ...
        use_low_speed_command_sampler = False
        zero_command_probability = 0.20
        low_command_probability = 0.20
        walk_command_probability = 0.60
        low_command_values = [0.05, 0.10, 0.15]
        low_command_jitter = 0.01
        walk_command_range = [0.20, 0.50]
        crawl_command_probability = 0.50
        crawl_command_values = [0.1, 0.2]
        crawl_command_jitter = 0.02
        gait_command_range = [0.50, 0.70]
        lin_vel_deadband = 0.03
        yaw_vel_deadband = 0.05
        gait_lin_threshold = 0.50
    ...
    class rewards(PrefixProto, cli=False):
        ...
        use_virtual_foot_contact = False
        virtual_foot_offset = 0.19
        valid_foot_height_threshold = 0.035
        illegal_calf_contact_time = 0.15
        crawl_min_contacts = 3
        crawl_swing_height_target = 0.025
        crawl_max_swing_height = 0.05
        crawl_max_air_time = 0.15
        feet_air_time_target = 0.15
        gait_swing_balance_ema_alpha = 0.02
        walk_step_duration = 0.35
        walk_swing_sequence = ["FR", "RL", "FL", "RR"]
        walk_swing_height_target = 0.03
        walk_swing_height_max = 0.06
        ...
        class scales(ParamsProto, cli=False, prefix="rewards.scales"):
            ...
            crawl_action = -0.
            crawl_base_height = -0.
            crawl_swing_clearance = -0.
            crawl_excess_air_time = -0.
            walk_exact_three_contacts = -0.
            walk_sequence_contact = -0.
            walk_swing_clearance = -0.
            walk_stance_slip = -0.
            walk_swing_progress = 0.
            walk_repeat_last_leg = -0.
            walk_repeat_recent_leg = -0.
            walk_swing_leg_coverage = 0.
            illegal_calf_contact = -0.
